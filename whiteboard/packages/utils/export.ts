import {
  exportToCanvasWithin as _exportToCanvasWithin,
...
export const exportToCanvasWithin = ({
  elements,
  appState,
  files,
  maxWidthOrHeight,
  ...
  return _exportToCanvasWithin(
    restoredElements,
    { ...restoredAppState, offsetTop: 0, offsetLeft: 0, width: appState?.width!, height: appState?.height!},
    files || {},
