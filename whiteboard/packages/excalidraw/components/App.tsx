...
class App extends React.Component<AppProps, AppState> {
  ...
  constructor(props: AppProps) {
    ...
    (window as any).actionManager = this.actionManager
    ...
    if (excalidrawAPI) {
      (window as any).updateScene = this.updateScene;
      (window as any).getAppState = () => this.state;
      (window as any).addFiles = this.addFiles;
      (window as any).getFiles = () => this.files;
